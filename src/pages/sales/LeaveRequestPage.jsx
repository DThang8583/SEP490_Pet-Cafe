    ...
    return (
        ...
        <Box sx={{ p: 3 }}>
            <Box sx={{ mb: 3, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <Button
                    variant="contained"
                    onClick={() => navigate('/sales/leave-requests/new')}
                    sx={{
                        textTransform: 'none',
                        px: 3,
                        py: 1.25,
                        borderRadius: 2,
                        boxShadow: `0 6px 18px ${alpha(COLORS.PRIMARY[300], 0.12)}`,
            ...
            <Paper sx={{ borderRadius: 2, overflow: 'hidden', boxShadow: `0 10px 30px ${alpha(COLORS.GRAY[900], 0.06)}` }}>
                ...
                <TableContainer sx={{ minHeight: 320 }}>
                    <Table>
                        <TableHead>
                                <TableRow sx={{ backgroundColor: alpha(COLORS.GRAY[50], 0.8) }}>
                                ...
                                {(!requests || requests.length === 0) ? (
                                    <TableRow>
                                        <TableCell colSpan={7} align="center" sx={{ py: 8 }}>
                                            <Box>
                                                <Typography variant="h6" sx={{ color: COLORS.TEXT.SECONDARY, mb: 1 }}>Không có đơn nào</Typography>
                                                <Typography variant="body2" sx={{ color: COLORS.TEXT.SECONDARY }}>Bạn có thể tạo đơn mới bằng nút ở góc trên bên phải.</Typography>
                                            </Box>
                                        </TableCell>
                                    </TableRow>
                                ) : (
