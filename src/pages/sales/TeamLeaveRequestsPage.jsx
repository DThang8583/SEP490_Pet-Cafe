    ...
    useEffect(() => {
        ...
        const loadTeams = async () => {
            try {
                ...
                console.error('Failed to load teams for sales leader page', err);
                setTeams([]);
            }
        };
        loadTeams();
    ...
    useEffect(() => {
        ...
        const loadRequestsForTeam = async () => {
            ...
            try {
                ...
                console.error('Failed to load leave requests for sales team', err);
                if (mounted) {
                    setAllRequests([]);
                ...
                <Stack direction="row" spacing={2.5} alignItems="center" sx={{ mb: 1 }}>
                    ...
                    <Box>
                        <Typography variant="h4" sx={{ fontWeight: 700 }}>
                            Đơn nghỉ phép (Trưởng nhóm - Sales)
                        </Typography>
                        <Typography variant="body2" sx={{ color: COLORS.TEXT.SECONDARY }}>
                            Xem các đơn của thành viên trong nhóm bạn quản lý (Sales)
                        </Typography>
                    </Box>
                </Stack>
            </Box>
