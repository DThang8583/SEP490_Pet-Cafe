                ...
                <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Box sx={{ flex: 1 }}>
                        ...
                        <Typography variant="body2" sx={{ color: COLORS.ERROR[600], fontWeight: 500 }}>
                            Thông tin phân công và trạng thái
                        </Typography>
                    </Box>
                </Stack>
            </Box>
            <DialogContent sx={{ p: 0 }}>
                <Box sx={{ p: 3 }}>
                    <Stack spacing={3}>
                        ...
                        >
                            <Typography variant="h6" sx={{ fontWeight: 800, mb: 2.5, color: COLORS.PRIMARY[700] }}>
                                📋 Thông tin chung
                            </Typography>
                            <Stack spacing={1.5}>
                        ...
                        >
                            <Typography variant="h6" sx={{ fontWeight: 800, mb: 2.5, color: COLORS.SUCCESS[700] }}>
                                👥 Phân công chi tiết
                            </Typography>
                            {task.type === 'internal' ? (
                        ...
                        {(task.type === 'internal' && (task.shifts || []).length === 1) && (
                            <Paper
                                ...
                                sx={{
                                    ...
                                    border: `2px solid ${alpha(COLORS.WARNING[200], 0.5)}`,
                                    borderRadius: 2
                                }}
                            >
                                <Typography variant="h6" sx={{ fontWeight: 800, mb: 2.5, color: COLORS.WARNING[700] }}>
                                    📅 Trạng thái theo ngày ({dates.length} ngày)
                                </Typography>
                                <Stack spacing={1}>
                                    {dates.map((d, idx) => {
