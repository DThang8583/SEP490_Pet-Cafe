...
const BookingFormPage = () => {
    ...
    // Load service and bookingData from localStorage or URL params
    useEffect(() => {
        const loadBookingData = () => {
            try {
                // Try to get from localStorage first (set by BookingPage)
                ...
                // Fallback: try to get service ID from URL params
                const serviceId = searchParams.get('serviceId');
                if (serviceId) {
                    loadServiceFromApi(serviceId);
                } else {
                    navigate('/booking');
                }
            } catch (error) {
    ...
    const handleAddToCart = () => {
        ...
        try {
            ...
            console.error('[BookingFormPage] Error adding to cart:', e);
    ...
    const handleSubmit = () => {
        ...
        // This can be used for future payment flow if needed
    ...
    const currentStep = 1; // BookingFormPage is step 1 (Điền thông tin)
