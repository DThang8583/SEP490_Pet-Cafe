...
const WorkingNotificationsPage = () => {
    ...
    const loadNotifications = async (pageIndex) => {
        ...
        try {
            ...
            console.log("[Working] Kết quả notifications:", json);
            ...
            <Container maxWidth="md" sx={{ position: "relative" }}>
                ...
                >
                    <Box>
                        ...
                        >
                            Tất cả thông báo liên quan đến ca làm việc của bạn.
                        </Typography>
                    </Box>
                    <Chip
...
export default WorkingNotificationsPage;
